...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_FetchData__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_Counter__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_FetchUSers__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_AddUser__ = __webpack_require__(11);
...
var routes = __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_2__components_Layout__["a" /* Layout */], null,
    ...
    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["Route"], { path: '/fetchusers', component: __WEBPACK_IMPORTED_MODULE_6__components_FetchUSers__["a" /* FetchUsers */] }),
    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["Route"], { path: '/adduser', component: __WEBPACK_IMPORTED_MODULE_7__components_AddUser__["a" /* AddUser */] }));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_react_hot_loader__ = __webpack_require__(6);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__routes__ = __webpack_require__(5);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__FetchUsers__ = __webpack_require__(15);
...
var AddUser = (function (_super) {
    ...
    function AddUser(props) {
        ...
        //    });
        var empid = _this.props.match.params["userid"];
        ...
        if (empid > 0) {
            ...
            _this.state = { title: "Create", loading: false, userData: new __WEBPACK_IMPORTED_MODULE_1__FetchUsers__["a" /* UserData */] };
        }
    ...
    AddUser.prototype.render = function () {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", null,
            ...
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("h3", null, "Employee"),
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("hr", null),
            contents);
    };
    // This will handle the submit form event. 
    AddUser.prototype.handleSave = function (event) {
        var _this = this;
        ...
        if (this.state.userData.userId) {
            fetch('api/User/Edit', {
                ...
                _this.props.history.push("/fetchusers");
            });
        }
        else {
    ...
    AddUser.prototype.handleCancel = function (e) {
        e.preventDefault();
        this.props.history.push("/fetchusers");
    };
    // Returns the HTML Form to the render() method. 
    AddUser.prototype.renderCreateForm = function () {
        return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("form", { onSubmit: this.handleSave },
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "form-group row" },
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("input", { type: "hidden", name: "userId", value: this.state.userData.userId })),
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "form-group row" },
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("label", { className: " control-label col-md-12", htmlFor: "Nom" }, "Nom"),
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "col-md-4" },
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("input", { className: "form-control", type: "text", name: "nom", defaultValue: this.state.userData.nom, required: true }))),
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "form-group row" },
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("label", { className: " control-label col-md-12", htmlFor: "Prenom" }, "Pr\u00E9nom"),
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "col-md-4" },
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("input", { className: "form-control", type: "text", name: "prenom", defaultValue: this.state.userData.prenom, required: true }))),
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "form-group row" },
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("label", { className: " control-label col-md-12", htmlFor: "Age" }, "Age"),
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "col-md-4" },
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("input", { className: "form-control", type: "text", name: "age", defaultValue: this.state.userData.age, required: true }))),
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "form-group row" },
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("label", { className: "control-label col-md-12", htmlFor: "Sexe" }, "Sexe"),
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "col-md-4" },
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("select", { className: "form-control", "data-val": "true", name: "sexe", defaultValue: this.state.userData.sexe, required: true },
                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("option", { value: "" }, "-- Select Gender --"),
                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("option", { value: "H" }, "Male"),
                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("option", { value: "F" }, "Female")))),
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "form-group row" },
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("label", { className: " control-label col-md-12", htmlFor: "DateLimite" }, "Date limite"),
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "col-md-4" },
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("input", { className: "form-control", type: "date", name: "dateLimite", required: true }))),
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FetchUsers; });
...
var FetchUsers = (function (_super) {
    __extends(FetchUsers, _super);
    function FetchUsers() {
        var _this = _super.call(this) || this;
        _this.state = { usersList: [], loading: true };
        fetch('api/User/Index')
            .then(function (response) { return response.json(); })
            .then(function (data) {
            _this.setState({ usersList: data, loading: false });
        });
        // This binding is necessary to make "this" work in the callback 
    ...
    FetchUsers.prototype.render = function () {
        var contents = this.state.loading
            ? __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("p", null,
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("em", null, "Loading..."))
            : this.renderEmployeeTable(this.state.usersList);
        return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", null,
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("h1", null, "Users Data"),
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("p", null, "This component demonstrates fetching Employee data from the server."),
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("p", null,
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["Link"], { to: "/adduser" }, "Create New")),
            contents);
    };
    // Handle Delete request for an employee 
    FetchUsers.prototype.handleDelete = function (id, nom, prenom) {
        var _this = this;
        if (!confirm("Voulez-vous vraiment supprimer l'utilisateur : " + prenom + " " + nom))
            ...
            fetch('api/User/Delete/' + id, {
                ...
                _this.setState({
                    usersList: _this.state.usersList.filter(function (rec) {
    ...
    FetchUsers.prototype.handleEdit = function (id) {
        this.props.history.push("/user/edit/" + id);
    };
    // Returns the HTML table to the render() method. 
    FetchUsers.prototype.renderEmployeeTable = function (empList) {
        var _this = this;
        return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("table", { className: 'table' },
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("thead", null,
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("tr", null,
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("th", null),
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("th", null, "UserId"),
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("th", null, "Nom"),
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("th", null, "Prenom"),
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("th", null, "Age"),
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("th", null, "Sexe"),
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("th", null, "Date Limite"))),
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("tbody", null, empList.map(function (user) {
                return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("tr", { key: user.userId },
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("td", null),
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("td", null, user.userId),
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("td", null, user.nom),
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("td", null, user.prenom),
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("td", null, user.age),
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("td", null, user.sexe),
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("td", null, user.dateLimite),
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("td", null,
                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("a", { className: "action", onClick: function (id) { return _this.handleEdit(user.userId); } }, "Edit"),
                        "  |",
                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("a", { className: "action", onClick: function (id) { return _this.handleDelete(user.userId, user.nom, user.prenom); } }, "Delete")));
            })));
    };
    return FetchUsers;
}(__WEBPACK_IMPORTED_MODULE_0_react__["Component"]));
            ...
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: 'navbar navbar-inverse' },
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: 'navbar-header' },
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("button", { type: 'button', className: 'navbar-toggle', "data-toggle": 'collapse', "data-target": '.navbar-collapse' },
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("span", { className: 'icon-bar' }),
                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("span", { className: 'icon-bar' })),
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["Link"], { className: 'navbar-brand', to: '/' }, "LcCoatchingElectron")),
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("ul", { className: 'nav navbar-nav' },
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("li", null,
                            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["NavLink"], { to: '/fetchdata', activeClassName: 'active' },
                                ...
                                " Fetch data")),
                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("li", null,
                            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["NavLink"], { to: '/fetchusers', activeClassName: 'active' },
                                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("span", { className: 'glyphicon glyphicon-th-list' }),
                                " Fetch Users"))))));
    };
    return NavMenu;
